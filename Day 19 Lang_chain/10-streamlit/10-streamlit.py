...
if not os.getenv("GROQ_API_KEY"):
    st.info(
        "Add GROQ_API_KEY to a .env file to chat. Get a free key at console.groq.com/keys."
    )
    st.stop()
...
def get_chain():
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                "You are a helpful assistant for an Indian e-commerce store. Keep replies concise.",
            ),
