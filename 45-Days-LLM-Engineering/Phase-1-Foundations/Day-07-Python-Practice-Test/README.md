...
- `python q11_temperature_converter.py` — Python Q11 Temperature Converter.
- `python q12_number_stats.py` — Python Q12 Number Stats.
- `python q14_set_compare.py` — Python Q14 Set Compare.
- `python q15_grade_book.py` — Python Q15 Grade Book.
